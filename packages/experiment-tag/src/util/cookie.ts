...
/**
 * Synchronous write in analytics-core's `CookieStorage` wire format (base64 of
 * URL-encoded JSON), so a value round-trips through {@link readCookieStorageSync}
 * and stays readable by other subdomains and the async storage. Blocked cookie
 * I/O degrades silently, as the raw paths do.
 */
